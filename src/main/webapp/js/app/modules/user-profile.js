...
define(['jquery', 'bootstrap', 'handlebars', 'jms', 'validate', 'ajaxHandler', 'jqueryForm', 'formValidator',
        'selector', 'additionalMethods','eventHandler'],
    function($, bootstrap, handlebars, jms, validate, ajaxHandler, jqueryForm, formValidator,
             selector, additionalMethods, eventHandler) {
