 ...
 */
define(['jquery', 'bootstrap', 'jms', 'validate',  'formValidator', 'additionalMethods', 'questionnaire', 'jqueryForm', 'eventHandler'],
        function($, bootstrap, jms, validate, formValidator, additionalMethods, questionnaire, jqueryForm, eventHandler) {
            ...
            jms.UserApplicationForm = userApplicationForm;
