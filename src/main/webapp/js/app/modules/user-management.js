...
define(['jquery', 'bootstrap', 'handlebars', 'jms', 'validate', 'ajaxHandler', 'formValidator',
        'additionalMethods', 'pagination', 'selector', 'jqueryForm', 'eventHandler', 'questionnaire'],
        function($, bootstrap, handlebars, jms, validate, ajaxHandler, formValidator,
                 additionalMethods, pagination, selector, jqueryForm, eventHandler, questionnaire) {
                ...
                exportCSV: function() {
                    ...
                    $.ajax({
                        ...
                        success : function(data) {
                            ...
                            location.href = "/jms/downloadCsv?csvFileName=" + data.returnValue;
                        }
                    });
                },
                q1: function(){
            ...
            jms.UserManagement = userManagement;
