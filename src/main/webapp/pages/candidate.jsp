    	...
    	<div class="container">
            <div class="row">
                <span class="col-sm-9 rightBorder equalCol">
                    <form class="candidateForm" id="candidateForm" role="form" action="addOrUpdCandidate" method="post">
                    	<div class="row">
                        	<div>Gender</div>
                        	<div class="radioRow">
                        ...
                        <div id="candidateInfoForm" class="row">
	                        <script id="candidateProfileTable" type="text/x-handlebars-template">
	                        	<div class="row">
	                            ...
	                            <br>
	          					<div class="table">
					                 <table width="750px" border="1" cellspacing="0" cellpadding="0">
					                     ...
					                     <tr>
					                     <td id="educationList[3].degree" name="educationList[3].degree" value="other">Other</td>
			                ...
			                <div class="row">
	                            <input type="button" id="candidateProfile_submit" value="submit"/>
	                        </div>
                    </form>
                </span>
                
                <!-- Button trigger modal -->
                <button type="button" id="candidateModelTrigger" data-toggle="modal" data-target="#candidateModel" style="display:none"></button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="buttonsRow">
                                ...
                                <button type="button" class="white-bt" data-dismiss="modal" id="candidateCancel">cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
